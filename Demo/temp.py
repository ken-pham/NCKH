...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=('https://download.openmmlab.com/mmaction/skeleton/posec3d/posec3d_ava.pth'),
    ...
    parser.add_argument(
        '--skeleton-checkpoint',
        default='https://download.openmmlab.com/mmaction/skeleton/posec3d/posec3d_k400.pth',
